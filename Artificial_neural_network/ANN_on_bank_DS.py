...
onehotencoder = OneHotEncoder(categorical_features = [1])#which creates the dummy variable for index 1, so that it should not compaire spain france , germany as higher or lower
...
#or
#(normalize) feature scaling for x
X = (X - X.mean()) / X.std()
print(X)
